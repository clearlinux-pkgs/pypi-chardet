...
Source0  : https://files.pythonhosted.org/packages/41/32/cdc91dcf83849c7385bf8e2a5693d87376536ed000807fa07f5eab33430d/chardet-5.1.0.tar.gz
...
%prep
%setup -q -n chardet-5.1.0
cd %{_builddir}/chardet-5.1.0
pushd ..
cp -a chardet-5.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672267687
